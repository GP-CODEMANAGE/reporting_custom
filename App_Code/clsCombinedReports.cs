...
public class clsCombinedReports
{
    ...
    public string getFinalSp(ReportType Type)
    {
        ...
        else if (Type == ReportType.Rpt1LineChart)
        {
            ...
            lsSQL = "SP_R_CLIENT_GOALS_NEW_GA_BASEDATA @GroupName = " + ReportRollupGroupName + ", @TrxnGAFlagTxt = '" + GreshamAdvFlg + "',@AsOfDate = " + AsOfDates + ",@AssetNameTxt =" + AssetClass + "";
        }
        else if (Type == ReportType.Rpt1Table)
        {
            ...
            //lsSQL = "SP_R_ASSET_VALUE_NEW_GA_BASEDATA @GroupName =" + ReportRollupGroupName + ",@PositionGAFlagTxt='" + GreshamAdvFlg + "' ,@TrxnGAFlagTxt= '" + GreshamAdvFlg + "' ,@AsOfDate = " + AsOfDates + ",@AssetNameTxt ="+ AssetClass+ "";
        }
