...
/// <summary>
/// Summary description for clsCombineReports1
/// </summary>
public class clsCombinedReports1
{
    public clsCombinedReports1()
    {
        //
    ...
    private PdfPTable GetReport4Table(string GrpName, string strAssetClass, string ReportType)
    {
        ...
        if (ReportType == "LT") //long term 
            qry = getFinalSp(clsCombinedReports1.ReportType.Rpt4TableLT);

        else
            qry = getFinalSp(clsCombinedReports1.ReportType.Rpt4TableST);
    ...
    private string getLineChartReport3()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            LineChartNEW.ChartAreas[0].AxisY.Minimum = 100000;
            if (maxx1 != 0.0)
            { 
