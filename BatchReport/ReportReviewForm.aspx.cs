    ...
    public string BindGrid()
    {
        ...
        if (BatchGUID != "" && (HouseHold == "" || HouseHold == "null"))
        {
            lsSQL = "SP_S_REPORT_REVIEW @UserId=" + BatchGUID + ",@ViewId=" + View + ",@AdvisorId=" + Advisor + ",@AssociateId=" + Associate
                    + ",@HouseHoldIdNmbList=" + HouseHold + ",@BatchTypeId=" + BatchType + ",@MailTypeId =" + MailType + ",@OwnerId=" + BatchOwner + ",@BatchStatusId=" + BatchStatus
...
//IOrganizationService s1 =
        ...
        if (ddlAction.SelectedValue == "9")
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)  // To allow or disallow action logic
            {
                ...
                string BatchName = row.Cells[1].Text.Trim().Replace("Batch Name", "").Replace("&nbsp;", "");
                ...
                string BillingInvoiceid = row.Cells[28].Text.Trim().Replace("ssi_billinginvoiceid", "").Replace("&nbsp;", ""); ;
        ...
        String LegalEntityId, String FundId, String CommitmentReportHeader, String GAorTIAflag, String ReportRollupGroupIdName, String fsHHreportparametersId, String fsReportRollupGroupId, String fsHouseholdId, String fsFundIRR, String fsGreshamReportId, String fsLegalEntityTitle, String TempFolderPath, String FooterLocation, String ClientFootertext, String Ssi_GreshamClientFooter)
    {
        ...
        /* added on 05_27_2020 Footer Update Logic */
        ...
        // objCombinedReports.LogFileName = Session["Filename"].ToString();
        //added 5_20_2019 -- LegalEntity -- Title
