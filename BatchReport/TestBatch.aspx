<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestBatch.aspx.cs" Inherits="BatchReport_TestBatch" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Advent Batch Report (test)</title>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    Prior Date:</td>
                                <td style="width: 220px">
                                    &nbsp;<asp:TextBox ID="txtPriorDate" runat="server" ValidationGroup="myGroup"></asp:TextBox>&nbsp;
                                    <a onclick="showCalendarControl(txtPriorDate)">
                                        <img id="img1" alt="" border="0" src="images/calander.png" runat="server" />&nbsp;
                                    </a>
                                </td>
                                <td>
                                    &nbsp;<asp:CheckBox ID="chkNoComparison" runat="server" Text="no comparison line"
                            ...
                            <tr>
                                ...
                                <td style="height: 26px; width: 220px;">
                                    &nbsp;<asp:TextBox ID="txtEndDate" runat="server"></asp:TextBox>&nbsp;<a onclick="showCalendarControl(txtEndDate)">
                    ...
                    <td colspan="3">
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" TabIndex="1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:CheckBox runat="server" ID="chkbSelectBatch" Checked="false" /></ItemTemplate>
                                </asp:TemplateField>
