<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BatchReportTEST_Nightly.aspx.cs" Inherits="BatchReportTEST" Culture="en-US" %>
                ...
                <tr>
                    <td colspan="3" style="height: 18px">
                        <table>
                            ...
                            <tr>
                                <td class="auto-style1">Batch Type:</td>
                                <td class="auto-style2">&nbsp;<asp:DropDownList ID="ddlBatchType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlBatchType_SelectedIndexChanged">
