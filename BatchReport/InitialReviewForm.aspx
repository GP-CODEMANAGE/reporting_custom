<%@ Page Theme="Gresham" Debug="true" Language="C#" AutoEventWireup="true" CodeFile="InitialReviewForm.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="_InitialReviewForm" %>
...
.assDate { font-family:Frutiger 55 Roman;font-size:10pt;font-style:italic; }
    ...
    //onchange="Uploader();" 
     document.getElementById('tblBrowse').style.display = "none"; 
       if(document.getElementById("ddlAction").value == "5")
       {
            ...
            <tr>
                <td>
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td class="Titlebig" colspan="3">
                                <asp:Label ID="lblFilterHeader" runat="server" Font-Bold="True" Font-Size="Large"
                                    Text="Initial Review" Width="260px"></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="width: 20%">
                                <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Text="Created By:"></asp:Label></td>
                            <td style="width: 80%">
                        ...
                        <tr>
                            <td style="width: 20%">
                                <asp:Label ID="lblView" runat="server" Text="As Of Date/Letter Date:" Font-Names="Verdana"></asp:Label></td>
                            <td style="width: 80%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 30%" valign="top">
                                            <asp:DropDownList Font-Names="Verdana" ID="ddlAction" runat="server" onchange="Uploader();">
                                                ...
                                                <asp:ListItem Value="3">Remove Records</asp:ListItem>
                                                <asp:ListItem Value="4">Create Consolidated Pdf</asp:ListItem>
                                                <asp:ListItem Value="5">Merge Pdf</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:Button Font-Names="Verdana" ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click"
                                                OnClientClick="return CheckExtension();" /></td>
                                    </tr>
                                </table>
                            ...
                            <td colspan="2" valign="top">
                                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Household" DataField="HouseholdName" /><%--1--%>
                                        <asp:BoundField HeaderText="As Of Date/Letter Date" DataField="Asofdate" /><%--2--%>
                                        <asp:BoundField HeaderText="Batch Name" DataField="Batch Name" /><%--3--%>
                                        <asp:BoundField HeaderText="Next Batch Owner" DataField="Next Batch Owner" /><%--4--%>
                                        <asp:BoundField HeaderText="Mailing Status" DataField="Mailing Status" /><%--5--%>
                                        <asp:BoundField HeaderText="Status" DataField="Status" /><%--6--%>
                                         <asp:BoundField DataField="Send Via" HeaderText="Send Via" /><%--7--%>
                                        ...
                                        <asp:BoundField DataField="ssi_batchid" HeaderText="ssi_batchid" Visible="False" /><%--9--%>
                                        <asp:BoundField DataField="ssi_mailrecordsid" HeaderText="ssi_mailrecordsid" Visible="False" /><%--10--%>
                                        <asp:BoundField DataField="ssi_batchdisplayfilename" HeaderText="ssi_batchdisplayfilename"
                                            Visible="False" /><%--11--%>
                                        <asp:BoundField DataField="ssi_batchfilename" HeaderText="Batch File Name" Visible="False" /><%--12--%>
                                        <asp:BoundField DataField="ssi_secondaryownerid" HeaderText="ssi_secondaryownerid"
                                            Visible="False" /><%--13--%>
                                        <asp:BoundField DataField="ssi_batchreject" HeaderText="ssi_batchreject" Visible="False" /><%--14--%>
                                        <asp:BoundField DataField="ssi_mailrecords_del" HeaderText="ssi_mailrecords_del"
                                            Visible="False" /><%--15--%>
                                        <asp:BoundField DataField="BatchTypeId" HeaderText="BatchTypeId" Visible="False" /><%--16--%>
                                        <asp:BoundField DataField="SLOA" HeaderText="SLOA" /><%--17--%>

                                        

                                         <asp:BoundField DataField="AdvisorApprovalFlg" HeaderText="AdvisorApprovalFlg"  Visible="False"/><%--18--%>

                                        <asp:BoundField DataField="AssociateApprovalFlg" HeaderText="AssociateApprovalFlg"  Visible="False"/><%--19--%>

                                          <asp:BoundField DataField="ssi_BillingInvoiceId" HeaderText="ssi_BillingInvoiceId"  Visible="False"/><%--20--%>
