...
public class sharepoint
{
    ...
    public DataTable getSiteClientList()
    {
        ...
        try
        {
            ...
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "SuccessgetSiteClientList: " + DateTime.Now.ToString());
            }
            return dt;
        }
        catch(Exception exx)
        {
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Error Occurred getSiteClientList: " + exx.Message.ToString() + "--" + DateTime.Now.ToString());
            }
            return null;
        }
    ...
    public DataSet getTaxonomyClientPortal()
    {
        try
        {
            ...
            // TermStore termStore = taxonomySession.TermStores.GetByName("Taxonomy_4BLQTxDzt3+F9JB2YxRRiQ=="); //commented(12_7_2018) using Id instead of name
            // TermStore termStore = taxonomySession.TermStores.GetByName("Taxonomy_DOdImr1GNfDLqW7JHPfHeQ==");
            ...
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "getTaxonomyClientPortal Successfull" + DateTime.Now.ToString());
            }
            return dsTaxonomy;
        }
        catch (Exception ex)
        {
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Error Occurred getTaxonomyClientPortal: " + ex.Message.ToString() + "--" + DateTime.Now.ToString());
            }
            return null;
        }
    }
    ...
    public DataTable getTaxonomyCorrespondenceType()
    {
        try
        {
            ...
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Sccess getTaxonomyCorrespondenceType: " + DateTime.Now.ToString());
            }
        ...
        catch (Exception ex)
        {
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Error Occurred getTaxonomyCorrespondenceType: " + ex.Message.ToString() + "--" + DateTime.Now.ToString());
            }
            return null;
        }
    }
    ...
    public DataTable getActiveClientList()
    {
        ...
        try
        {
            ...
            context.Load(list);
            context.ExecuteQuery();
            View view = list.Views.GetByTitle("Class B Clients");
            ...
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Success getActiveClientList: " + DateTime.Now.ToString());
            }
            return dt;
        }
        catch (Exception ex)
        {
            if (LogFileName != "")
            {
                lg.AddinLogFile(LogFileName, "Error Occurred getActiveClientList: " + ex.Message.ToString() + "--" + DateTime.Now.ToString());
            }
            return null;
        }
    ...
    public DataTable getActiveClientListt()
    {
        try
        {
            string siteUrl = "https://greshampartners.sharepoint.com/sites/CS/";
