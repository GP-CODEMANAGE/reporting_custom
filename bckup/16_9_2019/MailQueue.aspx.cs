...
public partial class MailQueue : System.Web.UI.Page
{
                                    ...
                                    if (BatchFilePath != "&nbsp;" && BatchFilePath != "") //&& ssi_CSCiteUUID != "" && ssi_CSCiteUUID != "&nbsp;")
                                    {
                                        ...
                                        if (ssi_CSCiteUUID != "" && ssi_CSCiteUUID != "&nbsp;")
                                        {
                                            ...
                                            if (bLegalEntityFolder)// For LegalEntity Folder inside Household Library
                                            {
                                               ...
                                               " to " + NewCSSharepointFolderPath + "/PublishedDocuments/" + ssi_SPLEFolder + "<br/>" + exc.Message + ", " + exc.StackTrace);
                                                ...
                                                else
                                                {
                                                    ...
                                                    ClientServicesLink = CopyFilenewCS(NewCSSharepointFolderPath, BatchFileName, BatchFilePath, year, BatchType1, Quarter);
                                            ...
                                            else
                                            {
                                                ...
                                                IsSharepointSiteExists = CheckNewCSSiteExists(NewCSSharepointFolderPath, billingFlag);
                                                if (IsSharepointSiteExists)
                                                {
                                                    try
                                                    {
                    ...
                    foreach (GridViewRow row in GridView1.Rows)
                    {
                        ...
                        if (chkSelectNC.Checked == true)
                        {
                            ...
                            else
                            {
                                ...
                                //    bProceed = false;
                                //}
                                if (MailTypeId != row.Cells[2].Text)
                                {
                                    bProceed = false;
                                }
                                MailIdNmbListTxt = MailIdNmbListTxt + "," + row.Cells[17].Text;
    ...
    public bool CheckNewCSSiteExists(String URL, bool billingflag)
    {
        bool bProceed = false;
        try
        {
   ...
   <Where>
    ...
    public string CopyFilenewCS(string Ssi_SharePointReportFolder, string destFilename, string vSourcrFile, string year, string BatchType, string Quarter)  // string vSourcefile, string vDestinationFile
    {
