...
public partial class MailQueue : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (bListFetched)
            {
                                    ...
                                    if (BatchFilePath != "&nbsp;" && BatchFilePath != "") //&& ssi_CSCiteUUID != "" && ssi_CSCiteUUID != "&nbsp;")
                                    {
                                        ...
                                        if (ssi_CSCiteUUID != "" && ssi_CSCiteUUID != "&nbsp;")
                                        {
                                            ...
                                            if (bLegalEntityFolder)// For LegalEntity Folder inside Household Library
                                            {
                                                ...
                                                if (IsSharepointSiteExists)
                                                {
                                                    try
                                                    {
                                                        ...
                                                        ClientServicesLink = CopyFileinLegalEntityFolder(NewCSSharepointFolderPath, BatchFileName, BatchFilePath, "PublishedDocuments/" + ssi_SPLEFolder, year, BatchType1, Quarter);
                                               ...
                                               " to " + NewCSSharepointFolderPath + "/PublishedDocuments/" + ssi_SPLEFolder + "<br/>" + exc.Message + ", " + exc.StackTrace);
                                                ...
                                                else
                                                {
                                                    ...
                                                    ClientServicesLink = CopyFilenewCS(NewCSSharepointFolderPath, BatchFileName, BatchFilePath, year, BatchType1, Quarter, LegalEntityUUID);
                                            ...
                                            else
                                            {
                                                ...
                                                // if (SharepointFolder != "")
                                                //bool IsSharepointFolderExists = CheckFolderPathExists(SharepointFolder);
                                                IsSharepointSiteExists = CheckNewCSSiteExists(NewCSSharepointFolderPath);
                                                if (IsSharepointSiteExists)
                                                {
                                                    try
                                                    {
                                    ...
                                    if (BatchFilePath != "&nbsp;" && BatchFilePath != "" && ClientFolderFilePath != "&nbsp;" && ClientFolderFilePath != "")
                                    {
                                        ...
                                        if (ClientFolder.ToLower().Contains("clientportal"))
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                //Commented New Sharepoint Client Services site Changes 
                                                // bool result = CopyFiletoSharepoint(SharepointFolder, FileName, BatchFilePath, BatchType1, Batch_Name1, HouseHoldName, year, SharepointFolderFilePath, ssi_clientportalname);
                                                bResultClientPortal = CopyFiletoSharepoint("", FileName, BatchFilePath, BatchType1, Batch_Name1, HouseHoldName, year, "", ssi_clientportalname);
                ...
                if (ddlAction.SelectedValue == "4")//Create FED-EX CSV
                {
                    ...
                    sqlstr = "SP_S_FED_EX_EXPORT @MailIdNmbList='" + MailIdNmbListTxt + "'";
    ...
    public void SendEmail(string LEFolderName, string CLientServiceLink)
    {
        try
        {
            ...
            string ToEmailIDs = "skane@infograte.com";
            ...
            myMessage.Subject = '"' + LEFolderName + '"' + " " + " folder missing ";
    ...
    public bool CopyFiletoSharepoint(string sharepointfolderpath, string destFilename, string vSourcrFile, string BatchType, string BatchName, string HouseHoldName, string year, string SharepointFolderFilePath, string ClientPortalName)
    {
    ...
    public bool CheckNewCSSiteExists(String URL)
    {
        bool bProceed = false;
        try
        {
   ...
   <Where>
    ...
    public string CopyFilenewCS(string Ssi_SharePointReportFolder, string destFilename, string vSourcrFile, string year, string BatchType, string Quarter, string LegalEntityUUID)  // string vSourcefile, string vDestinationFile
    {
        ...
        try
        {
            ...
            else if (BatchType.ToUpper() == "MERGE")
            {
