...
public partial class BillingExcludeAssets : System.Web.UI.Page
{
        ...
        if (billingVal != "ALL")
        {
            ...
            if (dsData.Tables.Count > 0)
            {
                if (dsData.Tables[0].Rows.Count > 0)
                {
                    ...
                    dtData.Columns.Add("AAExtra"); // added 26/12/2019 Administered asset Basecamp request
                    foreach (DataRow row in dtData.Rows)
                    {
                        row["BillingExtra"] = row["FinalBillingMarketValue"].ToString();
                        row["AUMExtra"] = row["FinalAUMMarketValue"].ToString();
                        ...
                        row["AAExtra"] = row["FinalAAMarketValue"].ToString(); // added 26/12/2019 Administered asset Basecamp request
                    }
                    ...
                    gvBilling.Columns[64].Visible = true;
                    gvBilling.Columns[65].Visible = true;
                    gvBilling.Columns[66].Visible = true;
                    gvBilling.Columns[67].Visible = true;
                    ...
                    //  gvBilling.Columns[52].Visible = false;
                    //  gvBilling.Columns[53].Visible = false;
                    gvBilling.Columns[54].Visible = false;
                    ...
                    gvBilling.Columns[64].Visible = false;
                    gvBilling.Columns[65].Visible = false;
                    gvBilling.Columns[66].Visible = false;
                    gvBilling.Columns[67].Visible = false;
                    //string hed = gvBilling.Columns[10].HeaderText.ToString();

                    foreach (GridViewRow grow in gvBilling.Rows)
                    {
                        #region AA Category DropDwon
                        string AACategoryId = grow.Cells[69].Text;
                        DropDownList ddlAACategory = (DropDownList)grow.FindControl("ddlAACategory");


                        string sqlstr = "sp_s_BillingAAList";//Store Procedure to bind hold report dropdown
                        GM.getListForBindDDL(ddlAACategory, sqlstr, "DisplayTxt", "ID");
                        ddlAACategory.Items.Insert(0, "");
                        ddlAACategory.Items[0].Value = "0";
                        ddlAACategory.SelectedIndex = 0;


                        ddlAACategory.SelectedValue = AACategoryId;
                        ...
                        if (AssetLevelFlgNew == "True")
                        {
                            ...
                            TextBox TotalAAText = (TextBox)grow.FindControl("txtAA"); // added 26/12/2019 Administered asset Basecamp request
                            TotalAAText.Enabled = true; // added 26/12/2019 Administered asset Basecamp request
                        ...
                        if (TotalAssetLevelFlgNew == "True")
                        {
                            TextBox TotalAUMText = (TextBox)grow.FindControl("txtAUM");
                            TextBox TotalBillingText = (TextBox)grow.FindControl("txtBilling");
                            TextBox TotalAAText = (TextBox)grow.FindControl("txtAA");
                            TotalAAText.Enabled = false;
                            ...
                            cbAum.Visible = false;
                            CheckBox cbAA = (CheckBox)grow.FindControl("cbExcludeAA");// added 26/12/2019 Administered asset Basecamp request
                            cbAA.Visible = false;// added 26/12/2019 Administered asset Basecamp request
                            ...
                            val = Convert.ToDecimal(ActualVal.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "")) - Convert.ToDecimal(TotalAAText.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", ""));

                            grow.Cells[53].Text = currencyFormat(val.ToString());

                        }
                        string BillingExcludeFlg = grow.Cells[23].Text;
                        string AUMExcludeFlg = grow.Cells[24].Text;
                        string AAExcludeFlg = grow.Cells[54].Text;// added 26/12/2019 Administered asset Basecamp request
                        ...
                        // added 26/12/2019 Administered asset Basecamp request
                        if (AAExcludeFlg == "True")
                        {
                            TextBox TotalAAText = (TextBox)grow.FindControl("txtAA");
                            TotalAAText.Enabled = false;
                        }
                        ...
                        string ACLevelAAExceptionFlg = grow.Cells[55].Text;// added 26/12/2019 Administered asset Basecamp request
                        ...
                        // added 26/12/2019 Administered asset Basecamp request
                        if (ACLevelAAExceptionFlg == "True" && AssetLevelFlgNew != "True")
                        {
                            TextBox TotalAAText = (TextBox)grow.FindControl("txtAA");
                            TotalAAText.Enabled = false;

                            CheckBox cbAA = (CheckBox)grow.FindControl("cbExcludeAA");
                            cbAA.Enabled = false;
                            grow.Cells[56].Text = "3";
                        }
                        if (ACLevelAAExceptionFlg == "True" && AssetLevelFlgNew == "True")
                        {
                            grow.Cells[56].Text = "3";
                        ...
                        TextBox TotalAATText = (TextBox)grow.FindControl("txtAA");
                        string value = TotalAATText.Text;
                        ...
                        if (decimal.TryParse(value, out ul))
                        {
                            ...
                            TotalAATText.TextChanged -= txtAA_TextChanged;
                            TotalAATText.Text = string.Format(System.Globalization.CultureInfo.CreateSpecificCulture("en-US"), "{0:C2}", ul);
                            TotalAATText.TextChanged += txtAA_TextChanged;
                        }
                        ...
                        string AAType = grow.Cells[57].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "");// added 26/12/2019 Administered asset Basecamp request
                        ...
                        // added 26/12/2019 Administered asset Basecamp request
                        if (AAType != "" && AAType != "5")    // for AUM yellow color
                        {
                            int index = grow.RowIndex;
                            TextBox text1 = (TextBox)gvBilling.Rows[index].FindControl("txtAA");
                            text1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                        }
                        else if (AAType == "5")                // for AUM red color
                        {
                            int index = grow.RowIndex;
                            TextBox text1 = (TextBox)gvBilling.Rows[index].FindControl("txtAA");
                            text1.BackColor = System.Drawing.Color.FromName("#FF5353");
    ...
    protected void cbExcludeBilling_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ck1.Checked)
            {
                ...
                string ACLevelBillingExceptionFlg = grow.Cells[14].Text;
                string ACLevelAUMExceptionFlg = grow.Cells[15].Text;
                string ACLevelAAExceptionFlg = grow.Cells[55].Text;
                ...
                string AAExceptionType = grow.Cells[61].Text;
                ...
                if (AssetLevelFlg == "True")    //  for Total Asset class ID   set checkbox value = true
                {
                    ...
                    decimal TotalBilling = 0, TotalAUM = 0, TotalAA = 0;
                    int TotalRowIndex = 0;
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetLevelFlgNew == "True")
                        {
                            ...
                            TextBox AAText = (TextBox)gvrow.FindControl("txtAA");
                            decimal AAVal = Convert.ToDecimal(AAText.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", ""));
                            TotalAA = TotalAA + AAVal;
                        ...
                        //AA Negative Value change
                        if (gvrow.Cells[58].Text != "")
                        {
                            // gvrow.Cells[7].BackColor = System.Drawing.Color.FromName("#FCFB9C");
                            TextBox text1 = (TextBox)gvBilling.Rows[TotalRowIndex1].FindControl("txtAA");
                            text1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                        }
                        //AA Positive Value Change
                        if (gvrow.Cells[59].Text != "")
                        {
                            // gvrow.Cells[7].BackColor = System.Drawing.Color.FromName("#FCFB9C");
                            TextBox text1 = (TextBox)gvBilling.Rows[TotalRowIndex1].FindControl("txtAA");
                            text1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                        ...
                        string AAType = gvrow.Cells[57].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", "").Replace(",", "");
                        ...
                        //AA
                        TextBox aatext1 = (TextBox)gvBilling.Rows[index].FindControl("txtAA");
                        decimal aaval = Convert.ToDecimal(aatext1.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", "").Replace(",", ""));
                        if (Convert.ToDecimal(vActualValue) != aaval)
                            aatext1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                        else
                            aatext1.BackColor = System.Drawing.Color.White;

                        if (Convert.ToDecimal(vActualValue) > 0)  // for red color
                        {
                            if (Convert.ToDecimal(vActualValue) < aaval)
                                aatext1.BackColor = System.Drawing.Color.FromName("#FF5353");
                        }
                        else if (aaval > 0 && Convert.ToDecimal(vActualValue) < aaval)
                        {
                            if (Convert.ToDecimal(vActualValue) < aaval)
                                aatext1.BackColor = System.Drawing.Color.FromName("#FF5353");
                        }
                    ...
                    CheckBox CbAA = (CheckBox)gvBilling.Rows[TotalRowIndex].FindControl("cbExcludeAA");
                    CbAA.Visible = false;
                    ...
                    Totalval = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "").Replace(",", "")) - TotalAA;
                    gvBilling.Rows[TotalRowIndex].Cells[53].Text = currencyFormat(Totalval.ToString());
                    ...
                    //AA
                    TextBox aatex = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    decimal aaval1 = Convert.ToDecimal(aatex.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", ""));
                    if (Convert.ToDecimal(vActualValue) != aaval1)
                        aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                    else
                        aatex.BackColor = System.Drawing.Color.White;

                    if (Convert.ToDecimal(vActualValue) > 0)  // for red color
                    {
                        if (Convert.ToDecimal(vActualValue) < aaval1)
                            aatex.BackColor = System.Drawing.Color.FromName("#FF5353");
                    }
                    else if (aaval1 > 0 && Convert.ToDecimal(vActualValue) < aaval1)
                    {
                        if (Convert.ToDecimal(vActualValue) < aaval1)
                            aatex.BackColor = System.Drawing.Color.FromName("#FF5353");
                    }
                ...
                else    // For single record 
                {
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        string AAType = gvrow.Cells[57].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace(",", "");
                        //     PositiveBilling = PositiveBilling.Replace("&nbsp", "");
                        //if (BillingType != "1" && BillingType != "")
                        //{
                        //    int index = gvrow.RowIndex;
                        ...
                        //AA
                        TextBox aatext1 = (TextBox)gvBilling.Rows[index1].FindControl("txtAA");
                        decimal aaval = Convert.ToDecimal(aatext1.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", "").Replace(",", ""));
                        if (Convert.ToDecimal(vActualValue1) != aaval)
                            aatext1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                        else
                            aatext1.BackColor = System.Drawing.Color.White;
                        ...
                        else if (aaval > 0 && Convert.ToDecimal(vActualValue1) < aaval)
                        {
                            if (Convert.ToDecimal(vActualValue1) < aaval)
                                aatext1.BackColor = System.Drawing.Color.FromName("#FF5353");
                        }
                    ...
                    CheckBox CbAA = (CheckBox)gvBilling.Rows[TotalRowInde].FindControl("cbExcludeAA");
                    CbAA.Visible = false;
                    ...
                    Totalval = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "")) - TotalAA;
                    gvBilling.Rows[TotalRowInde].Cells[53].Text = currencyFormat(Totalval.ToString());
                    ...
                    //AA
                    TextBox aatex = (TextBox)gvBilling.Rows[TotalRowInde].FindControl("txtAA");
                    decimal aaval1 = Convert.ToDecimal(aatex.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", ""));
                    if (Convert.ToDecimal(vActualValue1) != aaval1)
                        aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                    else
                        aatex.BackColor = System.Drawing.Color.White;
                    ...
                    else if (aaval1 > 0 && Convert.ToDecimal(vActualValue1) < aaval1)
                    {
                        if (Convert.ToDecimal(vActualValue1) < aaval1)
                            aatex.BackColor = System.Drawing.Color.FromName("#FF5353");
                    }
            ...
            else
            {
                ...
                if (AssetLevelFlg == "True")                 //  for Total Asset class ID  set checkbox value = false
                {
                    ...
                    //AA
                    TextBox aatex = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    decimal aaval1 = Convert.ToDecimal(aatex.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", "").Replace(",", ""));
                    if (Convert.ToDecimal(vActualValue1) != aaval1)
                        aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                    else
                        aatex.BackColor = System.Drawing.Color.White;
                ...
                else  // for Single record  checkbox false
                {
                    ...
                    TotalActual = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "")).ToString();
                    //AA
                    Totalval = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "")) - TotalAA;
                    gvBilling.Rows[TotalRowIndex].Cells[53].Text = currencyFormat(Totalval.ToString());
                    ...
                    if (Convert.ToDecimal(TotalActual) > 0)  // for red color
                    {
                        if (Convert.ToDecimal(TotalActual) < value)
                            Billingtex.BackColor = System.Drawing.Color.FromName("#FF5353");
                    }
                    ...
                    if (Convert.ToDecimal(TotalActual) != aaval1)
                        aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                    else
                        aatex.BackColor = System.Drawing.Color.White;
                    ...
                    else if (aaval1 > 0 && Convert.ToDecimal(TotalActual) < aaval1)
                    {
                        if (Convert.ToDecimal(TotalActual) < aaval1)
                            aatex.BackColor = System.Drawing.Color.FromName("#FF5353");
                    }
        ...
        try
        {
            ...
            if (ck1.Checked)
            {
                ...
                if (AssetLevelFlg == "True")    //  for Total Asset class ID   set checkbox value = true
                {
                    ...
                    TextBox textAA = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    textAA.Text = TotalAA.ToString();
                    addFormat(textAA, "AA");
                ...
                else
                {
                    ...
                    Billingtxt.Text = "0";
                    Billingtxt.Enabled = false;
                    decimal newBilling = 0, TotalAUM = 0, TotalAA = 0;
                    grow.Cells[46].Text = "";
                    grow.Cells[33].Text = "";
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetClassID == AssetClassIDNew && AssetLevelFlgNew != "True" && totalBilling != "True")
                        {
                            ...
                            TextBox Billingtx = (TextBox)gvrow.FindControl("txtAUM");
                            decimal val = Convert.ToDecimal(Billingtx.Text.Replace("$", "").Replace(" ", "").Replace("(", "-").Replace(")", ""));
                            TotalAUM = TotalAUM + val;

                            TextBox aatx = (TextBox)gvrow.FindControl("txtAA");
                            decimal aaval = Convert.ToDecimal(aatx.Text.Replace("$", "").Replace(" ", "").Replace("(", "-").Replace(")", ""));
                            TotalAA = TotalAA + aaval;
                    ...
                    TextBox AAtext = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
                    AAtext.Text = TotalAA.ToString();
                    addFormat(AAtext, "AA");
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        string AAType = gvrow.Cells[57].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "");
                        //     PositiveBilling = PositiveBilling.Replace("&nbsp", "");
                        //if (BillingType != "1" && BillingType != "")
                        //{
                        //    int index = gvrow.RowIndex;
                    ...
                    text = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    text.Text = TotalAA.ToString();
                    addFormat(text, "AA");
            ...
            else
            {
                ...
                if (AssetLevelFlg == "True")                 //  for Total Asset class ID  set checkbox value = false
                {
                    ...
                    decimal TotalAUM = 0, TotalAA = 0, TotalBilling = 0;
                    int TotalRowIndex = 0;
                    string vActualValue1 = null;
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                    ...
                    TextBox txAA = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    txAA.Text = TotalAA.ToString();
                    addFormat(txAA, "AA");
                ...
                else
                {
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetClassID == AssetClassIDNew && AssetLevelFlgNew != "True" && totalBilling != "True")
                        {
                            ...
                            TextBox AAtx = (TextBox)gvrow.FindControl("txtAA");
                            decimal valAA = Convert.ToDecimal(AAtx.Text.Replace("$", "").Replace(" ", "").Replace("(", "-").Replace(")", ""));
                            TotalAA = TotalAA + valAA;
                        }
                    ...
                    TextBox txtAA = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
                    txtAA.Text = TotalAA.ToString();
                    addFormat(txtAA, "AA");
                    ...
                    TextBox textboxAA = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    textboxAA.Text = TotalAA.ToString();
                    addFormat(textboxAA, "AA");
    ...
    protected void cbExcludeAA_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            lblMessage.Text = "";
            ...
            if (ck1.Checked)
            {
                //TextBox tx = (TextBox)grow.Cells[53].FindControl("txtAA");
                //string A = tx.Text;
                string IdNumb = grow.Cells[22].Text;
                string AccountID = grow.Cells[10].Text;
                string SecurityID = grow.Cells[11].Text;
                ...
                if (AssetLevelFlg == "True")    //  for Total Asset class ID   set checkbox value = true
                {
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetClassID == AssetClassIDNew)
                        {
                            //  IdNumbTotalAsset = gvrow.Cells[21].Text;
                            rowindex = gvrow.RowIndex;
                            TextBox AAtxt = (TextBox)gvrow.FindControl("txtAA");
                            AAtxt.Text = "0";
                            AAtxt.Enabled = false;
                            CheckBox cbAA = (CheckBox)gvrow.FindControl("cbExcludeAA");
                            // cbAum.Checked = true;
                            cbAA.Enabled = false;
                            gvrow.Cells[55].Text = "True";

                            gvrow.Cells[56].Text = "3";

                            grow.Cells[58].Text = "";

                            gvrow.Cells[58].Text = "";   // positive AUM
                            // gvrow.Cells[44].Text = "";  // positive billing
                            //   gvrow.Cells[32].Text = "";  //sub Billing 
                            gvrow.Cells[59].Text = "";   // sun AUM
                    ...
                    decimal TotalBilling = 0, TotalAA = 0, TotalAUM = 0;// TotalAA = 0;
                    int TotalRowIndex = 0;
                    string vActualValue1 = null;
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        string BillingType = gvrow.Cells[49].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace(",", "");
                        string AUMType = gvrow.Cells[50].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace(",", "");
                        string AAype = gvrow.Cells[57].Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace(",", "");
                    ...
                    TextBox text = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    text.Text = TotalAA.ToString();
                    addFormat(text, "AA");

                    TextBox textAUMM = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAUM");
                    textAUMM.Text = TotalAUM.ToString();
                    addFormat(textAUMM, "AUM");
                    ...
                    //AUM
                    string TotalActual = gvBilling.Rows[TotalRowIndex].Cells[4].Text;
                    decimal Totalval = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "").Replace(",", "")) - TotalAA;
                    gvBilling.Rows[TotalRowIndex].Cells[53].Text = currencyFormat(Totalval.ToString());
                ...
                else
                {
                    ...
                    int roindex = grow.RowIndex;
                    int TotalRowIndex2 = 0;
                    TextBox Billingtxt = (TextBox)grow.FindControl("txtAA");
                    Billingtxt.Text = "0";
                    Billingtxt.Enabled = false;
                    decimal newBilling = 0, TotalValue = 0;
                    grow.Cells[58].Text = "";
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetClassID == AssetClassIDNew && AssetLevelFlgNew != "True" && totalBilling != "True")
                        {
                            ...
                            TextBox Billingtx = (TextBox)gvrow.FindControl("txtAA");
                            decimal val = Convert.ToDecimal(Billingtx.Text.Replace("$", "").Replace(" ", "").Replace("(", "-").Replace(")", ""));
                            TotalValue = TotalValue + val;
                    ...
                    TextBox text = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
                    ...
                    decimal TotalBilling = 0, TotalAA = 0, TotalAUM = 0;
                    int TotalRowIndex = 0;
                    string vActualValue1 = null;
            ...
            else
            {
                ...
                if (AssetLevelFlg == "True")                 //  for Total Asset class ID  set checkbox value = false
                {
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetClassID == AssetClassIDNew)
                        {
                            ...
                            TextBox AAtxt = (TextBox)gvrow.FindControl("txtAA");
                            //if (Convert.ToDecimal(gvrow.Cells[25].Text) == 0)
                            AAtxt.Text = gvrow.Cells[4].Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");
                            //else
                            //    AUMtxt.Text = gvrow.Cells[24].Text;

                            AAtxt.Enabled = true;
                            CheckBox cbBilling = (CheckBox)gvrow.FindControl("cbExcludeAA");
                            cbBilling.Checked = false;
                            cbBilling.Enabled = true;
                            // gvrow.Cells[42].Text = "";

                            gvrow.Cells[60].Text = "0";
                            gvrow.Cells[58].Text = "";
                            gvrow.Cells[44].Text = "";
                    ...
                    decimal TotalAA = 0, TotalAUM = 0, TotalBilling = 0;
                    int TotalRowIndex = 0;
                    string vActualValue1 = null;
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                    ...
                    TextBox tx = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    tx.Text = TotalAA.ToString();
                    addFormat(tx, "AA");
                ...
                else
                {
                    ...
                    int roindex = grow.RowIndex;
                    TextBox AAtxt = (TextBox)grow.FindControl("txtAA");
                    AAtxt.Enabled = true;

                    AAtxt.Text = grow.Cells[4].Text;
                    //else
                    //    Aumtxt.Text = grow.Cells[25].Text;
                    ...
                    TextBox tx = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
                    ...
                    TextBox textbox = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    textbox.Text = TotalAA.ToString();
                    addFormat(textbox, "AA");
    ...
    protected void txtBilling_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            decimal TotalBilling2 = 0, TotalAUM = 0, TotalAA = 0;
            int TotalRowIndex2 = 0;
            string vActualValue1 = null;
            foreach (GridViewRow gvrow in gvBilling.Rows)
            {
                ...
                {
                    // gvrow.Cells[7].BackColor = System.Drawing.Color.FromName("#FCFB9C");
                    TextBox text1 = (TextBox)gvBilling.Rows[TotalRowIndex].FindControl("txtAA");
                    text1.BackColor = System.Drawing.Color.FromName("#FCFB9C");
                }
                //AA Positive Value Change
                if (gvrow.Cells[59].Text != "")
            ...
            Totalval1 = Convert.ToDecimal(TotalActual1.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "").Replace(",", "")) - TotalAA;
            gvBilling.Rows[TotalRowIndex2].Cells[53].Text = currencyFormat(Totalval1.ToString());
            ...
            //AA
            TextBox aatex = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtA");
            decimal aaval1 = Convert.ToDecimal(aatex.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", ""));
            if (Convert.ToDecimal(vActualValue1) != aaval1)
                aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
            else
        ...
        try
        {
            ...
            foreach (GridViewRow gvrow in gvBilling.Rows)
            {
                ...
                if (AssetLevelFlgNew == "True")
                {
                    ...
                    TextBox AAText = (TextBox)gvrow.FindControl("txtAA");
                    TotalAA = TotalAA + Convert.ToDecimal(AAText.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", ""));
            ...
            CbAUM.Visible = false;
            CheckBox CbAA = (CheckBox)gvBilling.Rows[TotalRowIndex2].FindControl("cbExcludeAA");
            CbAA.Visible = false;
            ...
            Totalval = Convert.ToDecimal(TotalActual.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "").Replace(",", "")) - TotalAA;
            gvBilling.Rows[TotalRowIndex2].Cells[53].Text = currencyFormat(Totalval.ToString());
            ...
            TextBox aatex = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
            decimal aaval1 = Convert.ToDecimal(aatex.Text.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "").Replace("$", ""));
            if (Convert.ToDecimal(vActualValue1) != aaval1)
                aatex.BackColor = System.Drawing.Color.FromName("#FCFB9C");
            else
    ...
    protected void txtAA_TextChanged(object sender, EventArgs e)
    {
        try
        {
            //lblSavePopUp.Text = "changed";
            ...
            string IdNumbTotalAsset = null, TotalVal = null;
            int rowindex = -1;
            TextBox txtAA = (TextBox)sender;
            GridViewRow grow = (GridViewRow)txtAA.NamingContainer;
            string AANew = txtAA.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");
            string IdNumb1 = grow.Cells[61].Text;
            string AAExtra = grow.Cells[60].Text;
            decimal AAAssetValue = 0;
            decimal TotalAA = 0;
            decimal TotalAUM = 0;
            int ChildRowindex = grow.RowIndex;
            ...
            if (AssetLevelFlg == "False")
            {
                ...
                //else
                //{
                if (Convert.ToDecimal(AANew) != Convert.ToDecimal(vActual))
                {
                    //  if (Convert.ToDecimal(AUMNew) > 0)
                    //   decimal a = Convert.ToDecimal(AUMNew);
                    if (Convert.ToDecimal(AANew) < 0)
                    {
                        AA = Convert.ToDecimal(vActual) + Convert.ToDecimal(AANew);      // change value in textbox

                        if (Convert.ToDecimal(AA) < 0 && Convert.ToDecimal(vActual) > 0)
                        {
                        ...
                        grow.Cells[59].Text = AANew;
                        grow.Cells[58].Text = "";
                    }
                    else if (Convert.ToDecimal(AANew) > 0)
                    {
                        grow.Cells[59].Text = "";
                        grow.Cells[58].Text = AANew;
                    }
                    else
                    {
                        grow.Cells[59].Text = "";
                ...
                foreach (GridViewRow gvrow in gvBilling.Rows)   // For updating Total asset Value 
                {
                    string AssetClassIDNew = gvrow.Cells[12].Text;
                    string AssetLevelFlgNew = gvrow.Cells[16].Text;
                    string totalAA = gvrow.Cells[17].Text;
                    if (AssetClassID == AssetClassIDNew && AssetLevelFlgNew == "False")
                    {
                        TextBox tx = (TextBox)gvrow.FindControl("txtAA");
                        string val = tx.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");
                        //if(Convert.ToDecimal(val)>0)
                        AAAssetValue = AAAssetValue + Convert.ToDecimal(val);
                        //else
                        //    AUMAssetValue = AUMAssetValue - Convert.ToDecimal(val);
                        //IdNumbTotalAsset = gvrow.Cells[21].Text;
                        //rowindex = gvrow.RowIndex;
                ...
                TextBox txt = (TextBox)gvBilling.Rows[rowindex].FindControl("txtAA");
                txt.Text = AAAssetValue.ToString();
                addFormat(txt, "AA");
            ...
            else
            {
                ...
                if (Convert.ToDecimal(AANew) > 0)
                {
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        if (AssetLevelFlgNew != "True" && AssetClassID == AssetClassIDNew)
                        {
                            TextBox BillingText = (TextBox)gvrow.FindControl("txtAA");
                            BillingText.Enabled = false;
                            gvrow.Cells[56].Text = "1";
                ...
                else if (Convert.ToDecimal(AANew) < 0)
                {
                    decimal total = 0;
                    int Index = 0;
                    if ((Convert.ToDecimal(vActual) + Convert.ToDecimal(AANew)) > 0)
                    {
                        grow.Cells[59].Text = AANew;
                        grow.Cells[58].Text = "";
                        txtAA.Text = AANew;
                    ...
                    foreach (GridViewRow gvrow in gvBilling.Rows)
                    {
                        ...
                        {
                            TextBox AAText = (TextBox)gvrow.FindControl("txtAA");
                            total = total + Convert.ToDecimal(AAText.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", ""));
                        ...
                        if (AssetLevelFlgNew == "True" && AssetClassID == AssetClassIDNew)
                        {
                            Index = gvrow.RowIndex;
                            if (!flags)
                                gvrow.Cells[56].Text = "2";
                            else
                                gvrow.Cells[56].Text = "";
                        }
                    }

                    TextBox tx = (TextBox)gvBilling.Rows[Index].FindControl("txtAA");

                    if (!flags)
                    {
                        tx.Text = (Convert.ToDecimal(AANew) + total).ToString();
                    }
                    else
                    {
                        tx.Text = vActual;
            ...
            TextBox tex = (TextBox)gvBilling.Rows[TotalRowIndex2].FindControl("txtAA");
            tex.Text = TotalAA.ToString();
            addFormat(tex, "AA");
            addFormat(txtAA, "AA");
    ...
    public void addFormat(TextBox text, string Type)
    {
        ...
        {
            text.TextChanged -= txtAA_TextChanged;
            text.Text = string.Format(System.Globalization.CultureInfo.CreateSpecificCulture("en-US"), "{0:C2}", ul);
            text.TextChanged += txtAA_TextChanged;
        }
        else
    ...
    public void updateBill(GridViewRow row, bool bExcludeBilling, decimal dSubtractBilling, decimal dPositiveBilling, decimal dBillPer, String Type, string AACategory = null, bool IsBillPerOnly = false)
    {
        bool bISBilling = false;

        bool bProceed = true;
        string vBillingExceptionID = string.Empty;
        if (Type == "Billing")
            vBillingExceptionID = row.Cells[18].Text;  //17   BillingExceptionId 
        else if (Type == "AUM")
            vBillingExceptionID = row.Cells[36].Text;
        else if (Type == "AA")
            vBillingExceptionID = row.Cells[62].Text;
        ...
        if (bProceed)
        {
            ...
            if (!IsBillPerOnly)
            {
                ...
                if (Type == "AA" && bExcludeBilling == true)
                {
                    //objBillingException.ssi_excludeasset = new CrmBoolean();
                    //objBillingException.ssi_excludeasset.Value = bExcludeBilling;
                    objBillingException["ssi_excludeasset"] = bExcludeBilling;
                ...
                if ((dPositiveBilling != 0 && Type == "AA" || dSubtractBilling != 0) && Type != "Billing")
                {
                    //objBillingException.ssi_excludeasset = new CrmBoolean();
                    //objBillingException.ssi_excludeasset.Value = bExcludeBilling;
                    objBillingException["ssi_excludeasset"] = bExcludeBilling;
            ...
            if (AACategory != "" && AACategory != "0" && AACategory != null)
            {
                objBillingException["ssi_aacategory"] = new Microsoft.Xrm.Sdk.OptionSetValue(Convert.ToInt32(AACategory));
            }
    ...
    public void insertCRM(GridViewRow row, bool bExcludeBilling, bool bExcludeAum, decimal SubtractBilling, decimal SubtractAum, decimal vBilling, decimal vAum, bool bExcludeAA, decimal SubtractAA, decimal vAA, decimal Fees = 0, string type = null, string CloseDate = null,string AACategory =null)
    {
        ...
        TextBox AAtxt = (TextBox)row.FindControl("txtAA");   //6
        string vAAtext = AAtxt.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");

        CheckBox ExcludeAAcb = (CheckBox)row.FindControl("cbExcludeAA");   //7
        bool ExcludeAA = ExcludeAAcb.Checked;
        ...
        string vAAExceptionType = row.Cells[61].Text;
        string vAAExcludeFlg = row.Cells[54].Text;
        string vAAMarketValue = row.Cells[65].Text;
        string SubAA = row.Cells[59].Text;
        SubAA = SubAA.Replace("&nbsp", "");
        string ACLevelAAExceptionFlg = row.Cells[55].Text;
        ...
        if ((ACLevelBillingExceptionFlg != "True" || ACLevelAUMExceptionFlg != "True" || ACLevelAAExceptionFlg != "True") && vAssetExceptionFlg != "True")
        {
        ...
        if (type == "Billing")
        {
            objBillingException["ssi_aum"] = new Microsoft.Xrm.Sdk.OptionSetValue(Convert.ToInt32("100000000"));

        }
        else if (type == "AUM")
        {
            objBillingException["ssi_aum"] = new Microsoft.Xrm.Sdk.OptionSetValue(Convert.ToInt32("100000001"));
        }
      else  if (type == "AA")
        {
            objBillingException["ssi_aum"] = new Microsoft.Xrm.Sdk.OptionSetValue(Convert.ToInt32("100000002"));
        }

        if (bExcludeBilling || bExcludeAum|| bExcludeAA)
        {
            //objBillingException.ssi_aum = new CrmBoolean();
        ...
        if (SubtractAA != 0)
        {
            ...
            objBillingException["ssi_subtractfromasset"] = new Money(Math.Abs(SubtractAA));
        ...
        if (vAA != 0)
        {
            //objBillingException.ssi_billingassetamount = new CrmMoney();
            //objBillingException.ssi_billingassetamount.Value = Convert.ToDecimal(vAum);
            objBillingException["ssi_billingassetamount"] = new Money(Convert.ToDecimal(vAA));
        }
        #region Notinused
        ...
        string MinAAFutureDate = row.Cells[64].Text;
        ...
        MinAAFutureDate = MinAAFutureDate.Replace("&nbsp", "").Replace(";", "").Replace("(", "-").Replace(")", "");
        ...
        else if (type == "AA")
        {
            if (MinAAFutureDate != "")
            {
                DateTime date = DateTime.ParseExact(MinAAFutureDate, "MM/dd/yyyy", CultureInfo.InvariantCulture);
                //objBillingException.ssi_enddate = new CrmDateTime();
                //objBillingException.ssi_enddate.Value = date.AddDays(-1).ToString();
                objBillingException["ssi_enddate"] = date.AddDays(-1);
            }
    ...
    public bool checkChangesForInsertAA(GridViewRow row)
    {
        bool bIsResult = false;
        string TotalAssetLevelFlg = row.Cells[17].Text;
        ...
        if (TotalAssetLevelFlg != "True")
        {
            ...
            DropDownList ddlAACategory = (DropDownList)row.FindControl("ddlAACategory");
            string AACategoryId = ddlAACategory.SelectedValue;
            string vAACategoryId = row.Cells[69].Text;
            ...
            TextBox AAtxt = (TextBox)row.FindControl("txtAA");   //6
            string vAA = AAtxt.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");
            ...
            string vBillingExcludeFlg = row.Cells[23].Text;  //22   BillingExcludeFlg
            string vAAExcludeFlg = row.Cells[54].Text;  //54  AAExcludeFlg 



            string vBillingMarketValue = row.Cells[29].Text;  //28  FinalBillingMarketValue 
            string vAAMarketValue = row.Cells[65].Text;  //65  FinalAAMarketValue 
            string vBillingFeePct = row.Cells[27].Text;  //30  BillingFeePct 

            string positiveValue = row.Cells[58].Text;//PositiveAA
            string negetiveValue = row.Cells[59].Text;//SubtractAA
            ...
            if (Convert.ToBoolean(vAAExcludeFlg) != ExcludeAA)
                bIsResult = true;
    ...
    public void UpdatingDelete(GridViewRow row, string Type = null, string Isclose = null)
    {
        ...
        {
            vBillingExceptionID = row.Cells[62].Text;
            ssi_Startdate = row.Cells[66].Text;
        }
    ...
    public void SaveNew()
    {
        ...
        foreach (GridViewRow gvRow in gvBilling.Rows)
        {
            ...
            string AAExceptionID = gvRow.Cells[62].Text;// added 26/12/2019 Administered asset Basecamp request

            string ACLevelBillingExceptionFlg = gvRow.Cells[14].Text;
            string ACLevelAUMExceptionFlg = gvRow.Cells[15].Text;
            string ACLevelAAExceptionFlg = gvRow.Cells[55].Text;// added 26/12/2019 Administered asset Basecamp request
            //DateTime dAsOFDate = DateTime.ParseExact(AsOFDate, "MM/dd/yyyy", CultureInfo.InvariantCulture);

            BillingExceptionID = BillingExceptionID.Replace("&nbsp;", "");
            AumExceptionID = AumExceptionID.Replace("&nbsp;", "");
            AAExceptionID = AAExceptionID.Replace("&nbsp;", "");// added 26/12/2019 Administered asset Basecamp request
            ...
            // added 26/12/2019 Administered asset Basecamp request
            TextBox AAtxt = (TextBox)gvRow.FindControl("txtAA");   //4
            string vAA = AAtxt.Text.Replace("$", "").Replace(",", "").Replace("(", "-").Replace(")", "");
            ...
            // added 26/12/2019 Administered asset Basecamp request
            string SubAA = gvRow.Cells[59].Text;
            SubAA = SubAA.Replace("&nbsp", "");
            // added 26/12/2019 Administered asset Basecamp request
            string PositiveAA = gvRow.Cells[58].Text;
            PositiveAA = PositiveAA.Replace("&nbsp", "").Replace(";", "");
            ...
            CheckBox ExcludeAAcb = null;
            bool ExcludeAUM = false, ExcludeBilling = false, ExcludeAA = false;
            if (TotalAssetLevelFlg == "False")
            {
                ...
                // added 26/12/2019 Administered asset Basecamp request
                ExcludeAAcb = (CheckBox)gvRow.FindControl("cbExcludeAA");   //5
                ExcludeAA = ExcludeAAcb.Checked;
            }
            ...
            string AAFlag = gvRow.Cells[56].Text;     // added 26/12/2019 Administered asset Basecamp request
            ...
            string AAExceptionType = gvRow.Cells[61].Text;// added 26/12/2019 Administered asset Basecamp request

            AAExceptionType = AAExceptionType.Replace("&nbsp;", "");// added 26/12/2019 Administered asset Basecamp request
            ...
            string MinAAFutureDate = gvRow.Cells[64].Text;// added 26/12/2019 Administered asset Basecamp request

            MinFutureDate = MinFutureDate.Replace("&nbsp;", "");
            MinAumFutureDate = MinAumFutureDate.Replace("&nbsp;", "");
         
            #region AA Category
            DropDownList ddlAACategory = (DropDownList)gvRow.FindControl("ddlAACategory");
            string AACategoryId = ddlAACategory.SelectedValue;
            ...
            if (BillingFlag == "" && BillingExceptionType == "")
            {
                if (BillingExceptionID == "")
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        ...
                        {
                            if (ExcludeBilling)
                                insertCRM(gvRow, true, false, 0, 0, 0, 0, false, 0, 0, 0, "Billing");

                            else if (SubBilling != "")
                            {
                                insertCRM(gvRow, false, false, 0, Convert.ToDecimal(SubBilling), 0, 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                            }
                            else if (PositiveBilling != "")
                            {
                                insertCRM(gvRow, false, false, 0, 0, 0, Convert.ToDecimal(PositiveBilling), false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                            }
                            else if (Convert.ToDecimal(vBillingPer) != 0)
                            {
                                insertCRM(gvRow, false, false, 0, 0, 0, 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                            }
                        }
                            ...
                            if (!ExcludeBilling)
                                ...
                                else if (PositiveBilling != "")
                                {
                                    if (startDate < dAsOFDate)
                                    {
                                        UpdatingDelete(gvRow, "Billing", "Close");
                                        //   DeleteException(gvRow, "Billing");
                                        insertCRM(gvRow, false, false, 0, 0, Convert.ToDecimal(vBilling), 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                                    }
            ...
            else if (BillingFlag == "3")     // excude billing
            {
                ...
                else if (BillingExceptionID != "" && AssetLevelFlg == "True")
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        if (startDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "Billing", "Close");
                                insertCRM(gvRow, true, false, 0, 0, 0, 0, false, 0, 0, 0, "Billing", MinFutureDate);
                            }
                        }
                        else if (startDate == dAsOFDate)
                        {
                ...
                else if (BillingExceptionID == "" && TotalAssetLevelFlg == "False" && AssetLevelFlg == "True")
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        ...
                        insertCRM(gvRow, true, false, 0, 0, 0, 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                    }
                    //insertRecord(gvRow);
                ...
                if (BillingExceptionID != "" && AssetLevelFlg == "True")   //delete
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        if (startDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "Billing", "Close");
                                insertCRM(gvRow, false, false, 0, Convert.ToDecimal(SubBilling), 0, 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing", MinFutureDate);
                            }
                        }
                        else if (startDate == dAsOFDate)
                        {
                ...
                else
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        if (BillingExceptionID == "")
                        {
                            if (SubBilling != "")
                            {
                                insertCRM(gvRow, false, false, Convert.ToDecimal(SubBilling), 0, 0, 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                            }
                            //insertRecord(gvRow);
                        }
                        else
                    ...
                    if (checkChangesForInsert(gvRow))
                    {
                        if (PositiveBilling != "")
                        {
                            if (startDate < dAsOFDate)
                            {
                                ...
                                {
                                    UpdatingDelete(gvRow, "Billing", "Close");
                                    insertCRM(gvRow, false, false, 0, 0, Convert.ToDecimal(vBilling), 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing", MinFutureDate);
                                }
                ...
                else
                {
                    if (checkChangesForInsert(gvRow))
                    {
                        if (BillingExceptionID == "")
                        {
                            if (PositiveBilling != "")
                            {
                                insertCRM(gvRow, false, false, 0, 0, Convert.ToDecimal(PositiveBilling), 0, false, 0, 0, Convert.ToDecimal(vBillingPer), "Billing");
                            }
                        }
                        //insertRecord(gvRow);
                        else
                ...
                if (AumExceptionID == "")
                {
                    if (checkChangesForInsertAum(gvRow))
                    {
                        if (AssetLevelFlg == "False" && TotalAssetLevelFlg == "False")
                        {
                            // insertRecord(gvRow);
                            if (ExcludeAUM)
                                insertCRM(gvRow, true, true, 0, 0, 0, 0, false, 0, 0, 0, "AUM");

                            else if (SubAum != "")
                            {
                                insertCRM(gvRow, false, true, 0, Convert.ToDecimal(SubAum), 0, 0, false, 0, 0, 0, "AUM");
                            }
                            else if (PositiveAum != "")
                            {
                                insertCRM(gvRow, false, true, 0, 0, 0, Convert.ToDecimal(PositiveAum), false, 0, 0, 0, "AUM");
                            }
                            //else if (Convert.ToDecimal(vBillingPer) != 0)
                            //{
                ...
                else if (AumExceptionID != "" && AssetLevelFlg == "True")   //delete
                {
                    if (checkChangesForInsertAum(gvRow))
                    {
                        if (dAUMstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AUM", "Close");
                                insertCRM(gvRow, true, true, 0, 0, 0, 0, false, 0, 0, 0, "AUM", MinAumFutureDate);
                            }
                        }
                        else if (dAUMstartDate == dAsOFDate)
                        {
                ...
                if (checkChangesForInsertAum(gvRow))
                {
                    if (AumExceptionID != "" && AssetLevelFlg == "True")   //delete
                    {
                        ...
                        if (dAUMstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AUM", "Close");
                                insertCRM(gvRow, false, true, 0, Convert.ToDecimal(SubAum), 0, 0, false, 0, 0, 0, "AUM", MinAumFutureDate);
                            }
                        }
                        else if (dAUMstartDate == dAsOFDate)
                        {
                    ...
                    else
                    {
                        ...
                        if (checkChangesForInsertAum(gvRow))
                        {
                            if (AumExceptionID == "")
                            {
                                insertCRM(gvRow, false, true, Convert.ToDecimal(SubAum), 0, 0, 0, false, 0, 0, 0, "AUM");
                            }
                            else
                            {
                                updateBill(gvRow, false, Convert.ToDecimal(SubAum), 0, 0, "AUM");
                ...
                else if (AumExceptionID != "" && AssetLevelFlg == "True")   //delete
                {
                    if (checkChangesForInsertAum(gvRow))
                    {
                        if (dAUMstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AUM", "Close");
                                insertCRM(gvRow, false, true, 0, 0, Convert.ToDecimal(vAUM), 0, false, 0, 0, 0, "AUM");
                            }
                            else
                            {
                                UpdatingDelete(gvRow, "AUM", "Close");
                                insertCRM(gvRow, false, true, 0, 0, Convert.ToDecimal(vAUM), 0, false, 0, 0, 0, "AUM", MinAumFutureDate);
                            }
                ...
                else
                {
                    if (checkChangesForInsertAum(gvRow))
                    {
                        if (AumExceptionID == "")
                            if (PositiveAum != "")
                            {
                                insertCRM(gvRow, false, true, 0, 0, 0, Convert.ToDecimal(vAUM), false, 0, 0, 0, "AUM");
                            }
                            //insertRecord(gvRow);
                            else
                            {
                    ...
                    else
                    {
                        if (checkChangesForInsertAum(gvRow))
                            if (dAUMstartDate < dAsOFDate)
                            {
                                ...
                                {
                                    UpdatingDelete(gvRow, "AUM", "Close");
                                    insertCRM(gvRow, true, true, 0, 0, 0, 0, true, 0, 0, 0, "AUM", MinAumFutureDate);
                                }
                            }
                            else if (dAUMstartDate == dAsOFDate)
                            {
            ...
            #region AA
            DateTime dAAstartDate;
            string AAStartDate = gvRow.Cells[66].Text;
            dAAstartDate = DateTime.ParseExact(AAStartDate, "MM/dd/yyyy", CultureInfo.InvariantCulture);

            if (AAFlag == "" && AAExceptionType == "")
            {
                if (AAExceptionID == "")
                {
                    if (checkChangesForInsertAA(gvRow))
                    {
                        if (AssetLevelFlg == "False" && TotalAssetLevelFlg == "False")
                        {
                            // insertRecord(gvRow);
                            if (ExcludeAA)//HERE
                                ...
                                insertCRM(gvRow, true, false, 0, 0, 0, 0, true, 0, 0, 0, "AA");

                            else if (SubAA != "")
                            {
                                insertCRM(gvRow, false, false, 0, Convert.ToDecimal(SubAA), 0, 0, true, 0, 0, 0, "AA", null ,AACategoryId);
                            }
                            else if (PositiveAA != "")
                            {
                                insertCRM(gvRow, false, false, 0, 0, 0, Convert.ToDecimal(PositiveAA), true, 0, 0, 0, "AA", null, AACategoryId);
                            }
                            else if (Convert.ToDecimal(AACategoryId) != 0)
                            {
                                insertCRM(gvRow, true, false, 0, 0, 0, 0, true, 0, 0, 0, "AA",null,AACategoryId);
                            }
                        }
                    }
                }
            }
            else if (AAFlag == "3")   // Exclude 
            {
                if (AAExceptionID != "" && AssetLevelFlg != "True")   //delete
                {
                    if (dAAstartDate < dAsOFDate)
                    {
                        UpdatingDelete(gvRow, "AA", "Close");
                    }
                    else if (dAAstartDate == dAsOFDate)
                    {
                        UpdatingDelete(gvRow, "AA");
                        // DeleteException(gvRow, "AUM");
                    }
                }
                else if (AAExceptionID != "" && AssetLevelFlg == "True")   //delete
                {
                    if (checkChangesForInsertAA(gvRow))
                    {
                        if (dAAstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AA", "Close");
                                insertCRM(gvRow, true, false, 0, 0, 0, 0, true, 0, 0, 0, "AA", MinAAFutureDate,  AACategoryId);
                            }
                        }
                        else if (dAAstartDate == dAsOFDate)
                        {
                            if (ExcludeAA)
                            {
                                updateBill(gvRow, ExcludeAA, 0, 0, 0, "AA", AACategoryId);
                                // insertCRM(gvRow, true, false, 0, 0, 0, 0);

                            }
                            else if (PositiveAA != "")
                            {
                                updateBill(gvRow, false, 0, Convert.ToDecimal(PositiveAum), 0, "AA", AACategoryId);
                            }
                            else if (SubAA != "")
                            {
                                updateBill(gvRow, false, Convert.ToDecimal(SubAA), 0, 0, "AA", AACategoryId);
                            }
                            else
                            {
                                UpdatingDelete(gvRow, "AA");
                ...
                else if (AAExceptionID == "" && TotalAssetLevelFlg == "False" && AssetLevelFlg == "True")
                {
                    //  insertRecord(gvRow);
                    // updateBill(gvRow, true, 0, 0, 0, "Billing");
                    insertCRM(gvRow, true, false, 0, 0, 0, 0, true, 0, 0, 0, "AA", null, AACategoryId);
                ...
                if (checkChangesForInsertAA(gvRow))
                {
                    if (AAExceptionID != "" && AssetLevelFlg == "True")   //delete
                    {
                        ...
                        if (dAAstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AA", "Close");
                                insertCRM(gvRow, false, false, 0, Convert.ToDecimal(SubAA), 0, 0, true, 0, 0, 0, "AA", MinAAFutureDate,  AACategoryId);
                            }
                        }
                        else if (dAAstartDate == dAsOFDate)
                        {
                    ...
                    else
                    {
                        ...
                        if (checkChangesForInsertAA(gvRow))
                        {
                            if (AAExceptionID == "")
                            {
                                insertCRM(gvRow, false, false, Convert.ToDecimal(SubAA), 0, 0, 0, true, 0, 0, 0, "AA", null, AACategoryId);
                            }
                            else
                            {
                                updateBill(gvRow, false, Convert.ToDecimal(SubAA), 0, 0, "AA", AACategoryId);
                ...
                else if (AAExceptionID != "" && AssetLevelFlg == "True")   //delete
                {
                    if (checkChangesForInsertAA(gvRow))
                    {
                        if (dAAstartDate < dAsOFDate)
                        {
                            ...
                            {
                                UpdatingDelete(gvRow, "AA", "Close");
                                insertCRM(gvRow, false, false, 0, 0, Convert.ToDecimal(vAA), 0, true, 0, 0, 0, "AA", null, AACategoryId);
                            }
                            else
                            {
                                UpdatingDelete(gvRow, "AA", "Close");
                                insertCRM(gvRow, false, false, 0, 0, Convert.ToDecimal(vAA), 0, true, 0, 0, 0, "AA", MinAAFutureDate,  AACategoryId);
                            }

                        }
                        else if (dAAstartDate == dAsOFDate)
                        {
                            updateBill(gvRow, false, 0, Convert.ToDecimal(vAA), 0, "AA", AACategoryId);
                        }
                    }
                }
                else
                {
                    if (checkChangesForInsertAA(gvRow))
                    {
                        if (AAExceptionID == "")
                            if (PositiveAA != "")
                            {
                                insertCRM(gvRow, false, false, 0, 0, 0, Convert.ToDecimal(vAA), true, 0, 0, 0, "AA", null, AACategoryId);
                            }
                            //insertRecord(gvRow);
                            else
                            {

                                updateBill(gvRow, false, 0, Convert.ToDecimal(vBilling), 0, "AA", AACategoryId);
                            }
                    }
                }
            }
            ...
            else if (AAExceptionID != "")
            {
                if (!ExcludeAA)
                {

                    if ((SubAA != "" || PositiveAA != ""))  //&& ExcludeBilling !=Convert.ToBoolean( vBillingExcludeFlg)
                    {
                        if (SubAA != "")
                        {
                            if (dAAstartDate < dAsOFDate)
