...
{          
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtFundDesc1.EditorHtml = sr.ReadToEnd();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string ABC = txtFundDesc1.EditorHtml.ToString();
                            ...
                            if (trFund.Visible == true)
                            {
                                ...
                                if (htmlEditor != null)
                                {
                                    ...
                                    if (txtFundDesc.Value != "")
                                    {
                                        ...
                                        // objTemplateFund["ssi_fundtxt"] = txtFundDesc.Value;
                                        objTemplateFund["ssi_fundtxt"] = txtFundDesc1.EditorHtml.ToString(); ;
                                    }
                                }
    ...
    private string GetcurrentUser(bool GetName)
    {
        ...
        sqlstr = "select top 1 internalemailaddress,systemuserid,left(ltrim(firstname),1) + '' + LastName as customname from systemuser where domainname= '" + strUserName + "'";
        DB clsDB = new DB();
