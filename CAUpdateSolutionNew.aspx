<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CAUpdateSolutionNew.aspx.cs"
    Inherits="CAUpdateSolution" Culture="en-US" %>
...
<META HTTP-EQUIV="Expires" CONTENT="-1">--%>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OpenChild(PositionId) {
            ...
            var myObject = window.showModalDialog("PopUpCAUpdateSolution.aspx?posid=" + PositionId, myObject, WinSettings);
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table>
                ...
                <tr>
                    <td colspan="3">
                        <strong>View&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:DropDownList
                            ID="ddlView" runat="server" OnSelectedIndexChanged="ddlView_SelectedIndexChanged"
                            AutoPostBack="True">
                            <asp:ListItem Value="ALL">ALL</asp:ListItem>
                            <asp:ListItem Value="Action Required by Me">Action Required by Me</asp:ListItem>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <%--<asp:Label ID="lblUpdateMonth" Font-Bold="true" runat="server"></asp:Label>--%>
                        <asp:DropDownList ID="ddlUpdateMonth" runat="server" AutoPostBack="True"
                            OnSelectedIndexChanged="ddlUpdateMonth_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" style="height: 22px">
                        <b>CA Updates Complete</b> &nbsp; &nbsp; &nbsp;
                        <asp:CheckBox ID="chkbCAUpcateCompleted" runat="server" />
                ...
                <tr>
                    <td><a href="#CAUpdate">Jump to CA Updates</a></td>
                </tr>
                <tr>
                    <td align="right" colspan="3" style="height: 22px;">&nbsp;<asp:DropDownList ID="ddlReportOptions" runat="server">
                ...
                <tr>
                    <td colspan="3">
                        <asp:Label ID="lblCashTransit" runat="server" Font-Bold="True" ForeColor="DarkOrange"
                            Text="CASH IN TRANSIT UPDATES"></asp:Label></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="gvCashinTransit" runat="server" Width="100%" AutoGenerateColumns="false"
                            ShowHeader="false" GridLines="None" OnRowDataBound="gvCashinTransit_RowDataBound"
                            TabIndex="1" Font-Names="Verdana" Font-Size="X-Small">
                            <Columns>
                                ...
                                <asp:BoundField DataField="previousmonthmktvalue" HeaderText="previous month value">
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CurrentMonthMktValue" HeaderText="Current Month Value"></asp:BoundField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtCashinTransit" Width="82px" AutoPostBack="true"
                                            onkeyup="return validateCAUpdateValue('grp2');" OnTextChanged="txtCashinTransit_TextChanged1"
                                            OnEnter="txtCashinTransit_TextChanged1" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtCashinTransit"
                                ...
                                <asp:BoundField DataField="ssi_positionid" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="Account" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="LegalEntity" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="Account" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="ssi_asofdate" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="_Headerflg" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="_800Acctflg" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="_Dataflg" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="_Totalflg" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="_OrderbyAcount" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="CurrentMonthMktValue" DataFormatString="{0:C}" HeaderText="Current Month Value"
                                    Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="ssi_accountid" HeaderText="Current Month Value" Visible="False"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="Li_SectorFlg" Visible="False"></asp:BoundField>
                                <asp:BoundField DataField="Lo_SectorFlg" Visible="False"></asp:BoundField>
                            </Columns>
                        </asp:GridView>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3" style="height: 232px">
                        ...
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" TabIndex="1"
                            ToolTip="CA Update" AllowSorting="True" OnRowDataBound="gvList_RowDataBound" OnRowCommand="gvList_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Account" HeaderText="Account" Visible="False" />
                                <asp:BoundField DataField="Account" HeaderText="Account" />
                                <asp:BoundField DataField="Name1" HeaderText="Name1">
                                ...
                                <asp:BoundField DataField="AssetClass" HeaderText="Asset Class" />
                                <asp:BoundField DataField="datasource" HeaderText="Source" />
                                <asp:BoundField DataField="ModifiedOn" DataFormatString="{0:MM/dd/yyyy}" HeaderText="Last Known Update" />
                                <asp:BoundField DataField="ModifiedbyName" HeaderText="Last Updated By" />
                                ...
                                <asp:TemplateField HeaderText="CA Update Value">
                                    <ItemTemplate>
