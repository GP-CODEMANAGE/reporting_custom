    ...
    <form id="form1" runat="server">
        <div onload="LOAD()">
            ...
            <table class="auto-style34">
                ...
                <tr>
                    <td class="auto-style39" colspan="3">Billing Worksheet Form
                    </td>
                    <td class="style1">&nbsp;
                    </td>
                    <td class="style3">&nbsp;
            ...
            Font-Size="X-Large" Visible="False"></asp:Label>
                     ...
                     <asp:Button ID="btnSave" runat="server" Text="Submit" OnClick="btnSave_Click"
                       ...
                       <asp:Button ID="btnSaveGenrate" runat="server" Text="Submit and Generate"
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="btnSaveGenratewithNonGA" runat="server" Text="Submit and Generate with Non-GA"
                           Visible="false" Width="260px" OnClick="btnSaveGenratewithNonGA_Click" Height="28px" />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:UpdatePanel ID="update1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gvBilling" runat="server" Width="100%" OnRowDataBound="gvBilling_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PosAssetClassName" HeaderText="Asset Class" />
                            <%--0--%>
                            <asp:BoundField DataField="Reporting Name" HeaderText="Reporting Name" />
                            <%--1--%>
                            <asp:BoundField DataField="Meeting book tab2 name" HeaderText="Column Name" />
                            <%--2--%>
                            <asp:BoundField DataField="AccountName" HeaderText="Legal Entity" />
                            <%--2--%>   <%--3--%>
                            ...
                            <asp:BoundField DataField="ssi_BillingMarketValue" HeaderText="Actual" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" />
                            <%--3--%>   <%--4--%>
                            ...
                            <asp:TemplateField HeaderText="Exclude Billing" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="cbExcludeBilling" AutoPostBack="true" OnCheckedChanged="cbExcludeBilling_CheckedChanged"
                                        Checked='<%# bool.Parse(Eval("BillingExcludeFlg").ToString()) %>' Enable='<%# !bool.Parse(Eval("BillingExcludeFlg").ToString()) %>'></asp:CheckBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Exclude AUM" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="cbExcludeAum" AutoPostBack="true" OnCheckedChanged="cbExcludeAUM_CheckedChanged"
                                        Checked='<%# bool.Parse(Eval("AUMExcludeFlg").ToString()) %>' Enable='<%# !bool.Parse(Eval("AUMExcludeFlg").ToString()) %>'></asp:CheckBox>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateField>
                            <%--7--%>    <%--8--%>
                        ...
                        <%--AutoPostBack="True" OnTextChanged="txtComment_TextChanged" OnTextChanged="txtBillPer_TextChanged" --%>
                            ...
                            <%--51--%>
                            <asp:TemplateField HeaderText="Non-GA Admin" ControlStyle-Width="120px">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtNGAA" runat="server" Width="100px" AutoPostBack="true" onkeypress="return onlyNumbers(this);" Font-Size="10" CssClass="TextAlgRgh"
                                        OnTextChanged="txtNGAA_TextChanged" Text='<%# Bind("FinalNGAAMarketValue") %>' DataFormatString="{0:C2}"></asp:TextBox>
                                    <%--  <asp:RegularExpressionValidator ID="regUnitsInStock" runat="server" ControlToValidate="txtBilling" ErrorMessage="Only numbers allowed" AutoPostBack="true" 
                            ValidationExpression="(^([0-9]*\d*\d{1}?\d*)$)" Display="Dynamic"></asp:RegularExpressionValidator>Onkeypress="return onlyNumbers(this);--%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--52--%>
                            <asp:TemplateField HeaderText="Admin Category">

                                <ItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlAdminCategory" OnSelectedIndexChanged="ddlAdminCategory_SelectedIndexChanged" AutoPostBack="true" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--53--%>
                            <asp:TemplateField HeaderText="Non-GA Service Type">

                                <ItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlNonGAServiceType" OnSelectedIndexChanged="ddlNonGAServiceType_SelectedIndexChanged" AutoPostBack="true" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--54--%>
                            <asp:BoundField DataField="ssi_AdminCategory" HeaderText="ssi_AdminCategory" />
                            <%--55--%>
                            <asp:BoundField DataField="ssi_NonGAServiceType" HeaderText="ssi_NonGAServiceType" />
                            <%--56--%>
                            <asp:BoundField DataField="FinalNGAAMarketValue" HeaderText="FinalNGAAMarketValue" />
                            <%--57--%>
                            <asp:BoundField DataField="ssi_AdminCategory" HeaderText="ssi_AdminCategory" />
                            <%--58--%>
                            <asp:BoundField DataField="ssi_NonGAServiceType" HeaderText="ssi_NonGAServiceType" />
                            <%--59--%>
                            <asp:BoundField DataField="BillingNGAAExceptionID" HeaderText="BillingNGAAExceptionID" />
                            <%--60--%>
                            <asp:BoundField DataField="ssi_NGAAStartDate" HeaderText="ssi_NGAAStartDate" />
                            <%--61--%>
                            <asp:BoundField DataField="ssi_NGAAEndDate" HeaderText="ssi_NGAAEndDate" />
                            <%--62--%>
                            <asp:BoundField DataField="MinNGAAFutureDate" HeaderText="MinNGAAFutureDate" />
                            <%--63--%>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="btnSave0" runat="server" Text="Submit" OnClick="btnSave_Click"
                       ...
                       <asp:Button ID="btnSaveGenrate0" runat="server" Text="Submit and Generate"
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="btnSaveGenratewithNonGA0" runat="server" Text="Submit and Generate with Non-GA"
                           Visible="false" Width="260px" OnClick="btnSaveGenratewithNonGA_Click" Height="28px" />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
